...
contract StrategyMasterChefLP is StratManager {
    ...
    address public masterchef = address(0xd6a4F121CA35509aF06A0Be99093d08462f53052);
  ...
  function changePerformanceFee(uint256 _newFee) public onlyOwner{
    ...
    function chargeFees() internal {                   
        ...
        IJoeRouter02(unirouter).swapExactTokensForTokens(toWrapped, 0, outputToWrappedRoute, address(this), now);
